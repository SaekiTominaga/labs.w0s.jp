...
<html lang="en">
	<head>
		...
		<title>PHP Session Demo (use_strict_mode=On)</title>
		<link rel="stylesheet" href="/labs.css" />
	</head>
	<body>
		<h1>PHP Session Demo (use_strict_mode=On)</h1>
	...
	'cookie_samesite' => 'Strict',
	'name' => 'LAB-STRICT-ON-SESSID',
	<a href="https://www.php.net/manual/en/session.configuration.php#ini.session.use-strict-mode">'use_strict_mode'</a> => 'On',
]);</code></pre>
